...
type UserProviderClient interface {
	...
	GetUser(ctx context.Context, in *GetUserReq, opts ...grpc_go.CallOption) (*User, common.ErrorWithAttachment)
...
type UserProviderClientImpl struct {
	...
	GetUser        func(ctx context.Context, in *GetUserReq) (*User, error)
...
func (c *userProviderClient) GetUser(ctx context.Context, in *GetUserReq, opts ...grpc_go.CallOption) (*User, common.ErrorWithAttachment) {
	out := new(User)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
...
func (UnimplementedUserProviderServer) GetUser(context.Context, *GetUserReq) (*User, error) {
...
func _UserProvider_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
